...
)
{
    ...
    switch(event)
    {
        case USB_DEVICE_EVENT_POWER_DETECTED:
            ...
            SYS_DEBUG_PRINT(SYS_ERROR_INFO, "USB Cable Attached\r\n");
            USB_DEVICE_Attach(appData.usbDevHandle);
            break;

        case USB_DEVICE_EVENT_POWER_REMOVED:
            // This means the device is not attached to the USB.
            SYS_DEBUG_PRINT(SYS_ERROR_INFO, "USB Cable Removed\r\n");
...
void APP_Tasks ( void )
{
    ...
    switch ( appData.state )
    {
        ...
        case APP_STATE_INIT:
        {
            ...
            if (appInitialized)
            {
                SYS_DEBUG_PRINT(SYS_ERROR_INFO, "USB Device Application Initialised\r\n");
